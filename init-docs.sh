...
echo "  mkdocs serve"
echo ""
echo "To host on AWS (password-protected):"
echo "  1. Deploy infrastructure: cd $THECOMPANY_DIR/cdk/docs-hosting && cdk deploy ..."
echo "  2. Create .docs-hosting.json with bucket and distributionId"
echo "  3. Run: ~/.claude/scripts/deploy-docs.sh $TARGET_DIR"
echo ""
echo "To check symlink health:"
